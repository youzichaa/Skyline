...
void (*myAES) (block *in, block *out, /*Mayank Changed*/int nblks, AES_KEY_TED *aesKey);
...
void AES_ecb_encrypt_chunk_in_out(block *in, block *out, /*Mayank Change*/ int nblks, AES_KEY_TED *aesKey) {
